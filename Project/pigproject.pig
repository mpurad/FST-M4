...
inputFile = LOAD 'hdfs:///user/mpurad/inputs' USING PigStorage('\t') AS (name:chararray, line:chararray);
...
-- rmf hdfs:///user/mpurad/PigProjectOutput;

-- Store the result in HDFS
STORE result INTO 'hdfs:///user/mpurad/PigProjectOutput' USING PigStorage('\t');
